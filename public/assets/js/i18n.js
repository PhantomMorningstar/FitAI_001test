(function exposeI18n(root) {
    ...
    const VI_TO_EN = Object.freeze({
        ...
        'Hoàn thành bảng câu hỏi để xem gợi ý': 'Complete the questionnaire to view suggestions',
        'FitAI dựa trên mục tiêu calorie, protein, mức vận động và dị ứng đã chọn.': 'FitAI uses your calorie target, protein target, activity level, and selected allergies.',
        'Gợi ý không thay thế chuyên gia y tế. Hãy cân khẩu phần và xác nhận dữ liệu dinh dưỡng bằng USDA.': 'Suggestions do not replace a health professional. Weigh portions and verify nutrition data with USDA.',
        'Chưa có gợi ý': 'No suggestions yet',
        'Hoàn thành bảng câu hỏi và kiểm tra an toàn để xem gợi ý món ăn.': 'Complete the questionnaire and safety check to view food suggestions.',
        'Bữa sáng': 'Breakfast',
        'Bữa trưa': 'Lunch',
        'Bữa tối': 'Dinner',
        'Cháo gạo lứt với ức gà và rau': 'Brown rice porridge with chicken breast and vegetables',
        'Khoai lang, trứng và rau xanh': 'Sweet potato, eggs, and leafy vegetables',
        'Yến mạch, chuối và sữa chua không đường': 'Oats, banana, and unsweetened yogurt',
        'Cơm, đậu phụ và rau củ': 'Rice, tofu, and vegetables',
        'Ức gà, cơm và rau luộc': 'Chicken breast, rice, and boiled vegetables',
        'Cá, khoai tây và salad': 'Fish, potatoes, and salad',
        'Thịt bò nạc, cơm và rau xào ít dầu': 'Lean beef, rice, and vegetables cooked with little oil',
        'Đậu phụ, cơm gạo lứt và rau củ': 'Tofu, brown rice, and vegetables',
        'Canh gà, cơm và nhiều rau': 'Chicken soup, rice, and plenty of vegetables',
        'Cá hấp, cơm và rau xanh': 'Steamed fish, rice, and leafy vegetables',
        'Thịt nạc, khoai lang và rau': 'Lean meat, sweet potato, and vegetables',
        'Đậu, cơm và bơ': 'Beans, rice, and avocado',
        'Ưu tiên thực phẩm giàu đạm và chất xơ để hỗ trợ cảm giác no trong mức năng lượng mục tiêu.': 'Prioritize protein- and fiber-rich foods to support fullness within your calorie target.',
        'Ưu tiên bữa ăn cân bằng và duy trì khẩu phần ổn định.': 'Prioritize balanced meals and consistent portions.',
        'Tăng năng lượng bằng khẩu phần lớn hơn hoặc thực phẩm giàu năng lượng, không chỉ bằng đồ ngọt.': 'Increase energy with larger portions or energy-dense foods, not only sweets.',
        'Đây là gợi ý nhóm món, không phải thực đơn y khoa. Hãy cân khẩu phần và tra cứu USDA trước khi lưu dinh dưỡng.': 'These are food-group suggestions, not a medical meal plan. Weigh the portion and check USDA before saving nutrition data.',
    ...
    const DYNAMIC_VI_TO_EN = Object.freeze([
        [/^(\d+) kcal\/ngày · (\d+) g protein$/, '$1 kcal/day · $2 g protein'],
        [/^(\d+)–(\d+) kcal · khoảng (\d+) g protein$/, '$1–$2 kcal · about $3 g protein'],
    ...
    const DYNAMIC_EN_TO_VI = Object.freeze([
        [/^(\d+) kcal\/day · (\d+) g protein$/, '$1 kcal/ngày · $2 g protein'],
        [/^(\d+)–(\d+) kcal · about (\d+) g protein$/, '$1–$2 kcal · khoảng $3 g protein'],
