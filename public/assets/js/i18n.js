(function exposeI18n(root) {
    ...
    const VI_TO_EN = Object.freeze({
        ...
        'Bạn có thể xem FitAI ở chế độ khách. Hãy đăng nhập để lưu và đồng bộ dữ liệu sức khỏe bằng Firebase.': 'You can explore FitAI in guest mode. Sign in to save and synchronize your health data with Firebase.',
        'BMR ước tính': 'Estimated BMR',
        'TDEE ước tính': 'Estimated TDEE',
        'Ảnh chỉ được gửi tới Google Gemini khi bạn nhấn “Phân tích ảnh bằng AI”. AI chỉ gợi ý món nhìn thấy; không thể đo khối lượng, dầu, nước sốt hoặc nguyên liệu bị che khuất.': 'The image is sent to Google Gemini only when you select “Analyze photo with AI”. AI only suggests visible foods; it cannot measure weight, oil, sauces, or hidden ingredients.',
        'Đăng nhập để lưu hồ sơ, bữa ăn và tiến độ an toàn trên nhiều thiết bị.': 'Sign in to save your profile, meals, and progress securely across devices.',
        'Cân nặng:': 'Weight:',
        'Dữ liệu chi tiết của biểu đồ có trong bảng lịch sử cân nặng bên dưới.': 'Detailed chart data is available in the weight-history table below.',
        'Trung bình 7 ngày sử dụng số đo của ngày hiện tại và 6 ngày trước đó. Kết quả xuất hiện khi có ít nhất 3 số đo trong khoảng này.': 'The 7-day average uses measurements from today and the previous 6 days. A result appears when this period contains at least 3 measurements.',
        'Lịch sử số đo cân nặng': 'Weight measurement history',
        'Ghi số bước và số phút vận động cường độ vừa đến mạnh. FitAI cần ít nhất 4 ngày dữ liệu để ước tính mức vận động quan sát được.': 'Record steps and minutes of moderate-to-vigorous activity. FitAI needs at least 4 days of data to estimate your observed activity level.',
        ...
        'Lịch sử bước chân và phút vận động': 'Step and active-minute history',
        'Số bước': 'Steps',
        'Theo dõi khả năng phục hồi mà không tự động thay đổi mục tiêu năng lượng.': 'Track recovery without automatically changing your energy target.',
        'Đêm ngủ từ 7 giờ': 'Nights with at least 7 hours of sleep',
        ...
        'chất béo': 'fat',
        'chất xơ': 'fiber',
        'Không thể lưu món có dữ liệu dinh dưỡng bị thiếu. Hãy chọn bản ghi USDA khác.': 'Food with missing nutrition data cannot be saved. Choose another USDA record.',
        ...
        'Bữa tối': 'Dinner',
        'Bữa phụ': 'Snack',
        'Phân bổ năng lượng tham khảo: sáng 25% + trưa 35% + tối 30% + bữa phụ 10% = 100% mục tiêu ngày.': 'Suggested energy split: breakfast 25% + lunch 35% + dinner 30% + snack 10% = 100% of the daily target.',
        'Cảnh báo dị ứng': 'Allergy warning',
        'FitAI chỉ lọc theo tag của món mẫu; không thể kiểm tra nước sốt, công thức thực tế hoặc nhiễm chéo khi chế biến. Luôn đọc nhãn, kiểm tra đầy đủ thành phần và hỏi người chế biến trước khi ăn.': 'FitAI only filters the tags attached to sample dishes; it cannot verify sauces, the actual recipe, or cross-contact during preparation. Always read the label, check every ingredient, and ask the person preparing the food before eating.',
        ...
        'Trái cây và sữa chua không đường': 'Fruit and unsweetened yogurt',
        'Trứng luộc và một phần trái cây': 'Boiled eggs and a serving of fruit',
        'Khoai lang và sữa đậu nành không đường': 'Sweet potato and unsweetened soy milk',
        'Trái cây và một phần nhỏ hạt không muối': 'Fruit and a small portion of unsalted nuts',
        ...
        'Ý tưởng món — chưa tính khẩu phần và dinh dưỡng chính xác. Hãy cân và tra cứu USDA.': 'Meal idea — portion size and nutrition have not been calculated. Weigh the food and check USDA.',
        'Các con số là ngân sách cho cả bữa, không phải dinh dưỡng đã tính của từng món gợi ý. Muốn biết khẩu phần thực tế, hãy cân nguyên liệu và tra cứu đúng thực phẩm trên USDA trước khi lưu.': 'The numbers are a budget for the whole meal, not calculated nutrition for each suggested dish. To determine the actual portion, weigh the ingredients and look up the correct food in USDA before saving.',
        ...
        'Chất béo': 'Fat',
        'Chất xơ': 'Fiber',
        'Xác nhận nhật ký đã đầy đủ': 'Confirm diary completeness',
        'Chưa tự xác nhận': 'Not self-confirmed',
        'Người dùng tự xác nhận': 'User self-confirmed',
        'Trạng thái đầy đủ do người dùng tự xác nhận. FitAI không tự kiểm chứng món ăn, khẩu phần hoặc đồ uống bị bỏ sót. Chỉ ngày đã tự xác nhận mới được dùng để hiệu chỉnh kế hoạch.': 'Completeness is self-confirmed by the user. FitAI does not independently verify foods, portions, or omitted drinks. Only self-confirmed days are used to calibrate the plan.',
        'Bạn vẫn có thể sửa hoặc xóa món; sau khi thay đổi, ngày đó cần được xác nhận lại.': 'You can still edit or delete foods; after a change, the day must be confirmed again.',
        'Hãy ghi tất cả món và đồ uống có năng lượng trong ngày.': 'Log all foods and calorie-containing drinks for the day.',
        'Xác nhận đã ghi đủ trong ngày': 'Confirm day is fully logged',
        'Đã xác nhận ngày này': 'Day confirmed',
        'Người dùng đã tự xác nhận ngày này được ghi đầy đủ; dữ liệu được dùng để đánh giá kế hoạch.': 'The user self-confirmed this day as fully logged; its data is used to evaluate the plan.',
        'Nếu bạn đã ghi đủ mọi món và đồ uống có năng lượng, hãy xác nhận ngày này.': 'If you have logged every food and calorie-containing drink, confirm this day.',
        'Thêm ít nhất một món trước khi xác nhận.': 'Add at least one food before confirming.',
        'Bạn đã tự xác nhận nhật ký ngày này là đầy đủ.': 'You self-confirmed this diary day as complete.',
        ...
        'Thời gian đạt mục tiêu là ước tính thô, không phải cam kết. Ước tính giả định mức vận động và tốc độ thay đổi cân nặng tương đối ổn định; kết quả thực tế có thể khác.': 'Time to goal is a rough estimate, not a promise. It assumes relatively stable activity and weight-change rates; actual results may differ.',
        ...
        'Khám phá ở chế độ khách': 'Explore as a guest',
        'Bạn có thể xem giao diện trước khi đăng nhập. Dữ liệu ở chế độ khách chỉ nằm trên thiết bị này và không được đồng bộ lên Firebase.': 'You can preview the app before signing in. Guest data stays only on this device and is not synchronized to Firebase.',
        'Tiếp tục ở chế độ khách': 'Continue as guest',
        ...
        'Chế độ ăn': 'Dietary preference',
        'Ăn đa dạng': 'Omnivorous',
        'Ăn chay có trứng và sữa': 'Lacto-ovo vegetarian',
        'Thuần chay (không thịt, cá, trứng, sữa)': 'Vegan (no meat, fish, eggs, or dairy)',
        'FitAI sẽ loại món thịt và cá khỏi phần gợi ý khi bạn chọn ăn chay.': 'FitAI will exclude meat and fish from suggestions when vegetarian is selected.',
        'Với chế độ ăn chay, hãy thay đổi nguồn đạm giữa đậu, đậu phụ, trứng hoặc sữa nếu phù hợp với dị ứng của bạn.': 'For a vegetarian diet, rotate protein sources such as beans, tofu, eggs, or dairy when compatible with your allergies.',
        'Với chế độ thuần chay, hãy thay đổi nguồn đạm thực vật giữa các loại đậu, đậu phụ và hạt phù hợp với dị ứng của bạn.': 'For a vegan diet, rotate plant protein sources such as beans, tofu, and nuts when compatible with your allergies.',
        'Lựa chọn chế độ ăn không hợp lệ.': 'The dietary preference is invalid.',
        'Đang áp dụng: Ăn chay — đã loại thịt và cá': 'Applied: Vegetarian — meat and fish excluded',
        'Đang áp dụng: Ăn đa dạng': 'Applied: Omnivorous',
        'Đang áp dụng: Thuần chay — đã loại thịt, cá, trứng và sữa': 'Applied: Vegan — meat, fish, eggs, and dairy excluded',
        'Không tìm thấy món phù hợp với lựa chọn hiện tại.': 'No suitable meal was found for the current selections.',
        'Một số bữa không còn món mẫu phù hợp với chế độ ăn và dị ứng đã chọn. FitAI sẽ không tự bỏ qua dị ứng; hãy kiểm tra thành phần thực tế và trao đổi với chuyên gia dinh dưỡng nếu chế độ ăn quá hạn chế.': 'Some meals have no sample dishes compatible with the selected diet and allergies. FitAI will not bypass an allergy; check the actual ingredients and consult a registered dietitian if the diet is overly restrictive.',
        'Tên món đã chọn có dấu hiệu chứa thịt hoặc cá, trong khi hồ sơ của bạn đang chọn ăn chay. Bạn vẫn muốn lưu món này?': 'The selected food name appears to contain meat or fish, while your profile is vegetarian. Do you still want to save this food?',
        'Tên món đã chọn có dấu hiệu chứa nguyên liệu động vật, trong khi hồ sơ của bạn đang chọn thuần chay. Bạn vẫn muốn lưu món này?': 'The selected food name appears to contain an animal-derived ingredient, while your profile is vegan. Do you still want to save this food?',
        'Đã hủy lưu để bạn kiểm tra lại món và thành phần thực tế.': 'Saving was cancelled so you can check the food and its actual ingredients.',
        ...
        'Mục tiêu:': 'Goal:',
        'Năng lượng duy trì:': 'Maintenance calories:',
        'Năng lượng mục tiêu:': 'Target calories:',
        'Điều chỉnh mỗi ngày:': 'Daily adjustment:',
        'Thay đổi ước tính mỗi tuần:': 'Estimated weekly change:',
        'Thời gian ước tính:': 'Estimated time:',
        'Tuổi:': 'Age:',
        'Quay lại': 'Back',
        'Tiếp theo': 'Next',
        ...
        'TDEE tham khảo từ vận động': 'Activity-based reference TDEE',
        'TDEE tham khảo từ vận động chỉ dùng để đối chiếu với hồ sơ. FitAI không tự động thay đổi mục tiêu calorie hoặc kế hoạch của bạn theo con số này.': 'The activity-based TDEE is for comparison with your profile only. FitAI does not automatically change your calorie target or plan based on this number.',
        'TDEE tham khảo từ vận động': 'Activity-based reference TDEE',
        'TDEE tham khảo từ vận động chỉ dùng để đối chiếu với hồ sơ. FitAI không tự động thay đổi mục tiêu calorie hoặc kế hoạch của bạn theo con số này.': 'The activity-based TDEE is for comparison with your profile only. FitAI does not automatically change your calorie target or plan based on this number.',
        ...
        'Ít vận động (văn phòng / ngồi nhiều)': 'Sedentary (desk work / mostly sitting)',
        'Vận động nhẹ (đi lại thường xuyên)': 'Lightly active (regular walking)',
        'Vận động vừa (lao động thể chất / thể thao)': 'Moderately active (physical work / exercise)',
        ...
        'kcal/ngày': 'kcal/day',
        'kg/tuần': 'kg/week',
        'Hãy đăng nhập để sử dụng tính năng AI.': 'Sign in to use AI features.',
        'Phiên đăng nhập không hợp lệ hoặc đã hết hạn. Hãy đăng nhập lại.': 'Your sign-in session is invalid or expired. Sign in again.',
        'Máy chủ chưa cấu hình FIREBASE_PROJECT_ID.': 'The server has not configured FIREBASE_PROJECT_ID.',
        'Bạn gửi câu hỏi quá nhanh. Hãy chờ một phút rồi thử lại.': 'Too many AI questions. Wait one minute and try again.',
        'Bạn phân tích ảnh quá nhanh. Hãy chờ một phút rồi thử lại.': 'Too many photo analyses. Wait one minute and try again.',
        ...
        'Tài khoản này đã bị vô hiệu hóa.': 'This account has been disabled.',
        ...
        'Nhắc nhở FitAI': 'FitAI reminder',
        'Đăng nhập để bắt đầu': 'Sign in to begin',
        'Dữ liệu hằng ngày sẽ được lưu riêng cho tài khoản của bạn.': 'Daily data will be stored separately for your account.',
        'Đã cập nhật gợi ý món ăn theo thông tin mới của bạn.': 'Meal suggestions were updated using your new information.',
        'Ngày nhật ký không hợp lệ.': 'The diary date is invalid.',
        'Hãy thêm ít nhất một món trước khi hoàn tất ngày.': 'Add at least one food before completing the day.',
        'Sửa': 'Edit',
        'Xóa': 'Delete',
        'món này': 'this food',
        'Chưa đủ dữ liệu để đánh giá hướng thay đổi cân nặng.': 'There is not enough data to evaluate the weight-change direction.',
        'Mức calorie đề xuất không vượt qua kiểm tra an toàn.': 'The proposed calorie target did not pass the safety check.',
        'Không áp dụng thay đổi. Hãy giữ mục tiêu hiện tại hoặc trao đổi với chuyên gia dinh dưỡng.': 'Do not apply the change. Keep the current target or speak with a dietitian.',
        'Không thể kiểm tra an toàn cho đề xuất calorie.': 'Unable to check the calorie proposal for safety.',
        '— email chưa xác minh': '— email not verified',
        'Chế độ khách — dữ liệu cloud chưa được lưu': 'Guest mode — cloud data has not been saved'
    });
    ...
    const DYNAMIC_VI_TO_EN = Object.freeze([
        ...
        [/^(\d+)% · khoảng (\d+) kcal · (\d+) g protein$/, '$1% · about $2 kcal · $3 g protein'],
        [/^Ngân sách bữa: (\d+)% · khoảng (\d+) kcal · (\d+) g protein$/, 'Meal budget: $1% · about $2 kcal · $3 g protein'],
    ...
    const DYNAMIC_EN_TO_VI = Object.freeze([
        ...
        [/^(\d+)% · about (\d+) kcal · (\d+) g protein$/, '$1% · khoảng $2 kcal · $3 g protein'],
        [/^Meal budget: (\d+)% · about (\d+) kcal · (\d+) g protein$/, 'Ngân sách bữa: $1% · khoảng $2 kcal · $3 g protein'],
